        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              icon: const Icon(Icons.thumb_up, color: Colors.white), // Icon added
              label: const Text("Vote Now"), // Text label
              style: ElevatedButton.styleFrom(
                foregroundColor: Colors.white,
                backgroundColor: const Color(0xFF1877F2),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10.0), // Border radius added
                ),
